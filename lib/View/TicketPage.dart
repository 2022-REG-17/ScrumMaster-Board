                              ...
                              return Card(
                                child: Container(
                                  ...
                                  child: Column(children: [
                                    ListTile(
                                      title: Text(
                                          ticketController.TicketTask[index].name,
                                          style: TextStyle(
                                              fontSize: 22,
                                    ...
                                    Container(
                                      ...
                                      alignment: Alignment.centerLeft,
                                      child: Text(
                                          ticketController.TicketTask[index].status
                                              .toString(),
                                          style: TextStyle(fontSize: 15)),
                                    ),
                                    SizedBox(height: 20),
                                    ...
                                    Container(
                                        ...
                                        child: Row(children: [
                                          IconButton(
                                            ...
                                            color: Colors.teal,
                                            onPressed: () {
                                              String id = ticketController.TicketTask[index].id;
                                              String name = ticketController.TicketTask[index].name;
                                              String createdDate = ticketController.TicketTask[index].createdDate;
                                              String description = ticketController.TicketTask[index].description;
                                              String status = ticketController.TicketTask[index].status;
                                              String comment = ticketController.TicketTask[index].comment;
                                              Navigator.push(
                                                context,
                                                MaterialPageRoute(
                                                  builder: (context) =>
                                                      Edit_Ticket(
                                                        id: id, name: name, createdDate: createdDate, description: description, status: status, comment: comment,
                                                      ),
                                                ),
                                              );
                                            },
