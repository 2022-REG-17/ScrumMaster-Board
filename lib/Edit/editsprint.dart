...
class Edit_Sprint extends StatefulWidget {
  Edit_Sprint(String id, String name, String startDate, String dueDate);
  @override
...
class _Edit_SprintState extends State<Edit_Sprint> {
  ...
  void initState() {
    sprintController
        .startdateEditingController.text; //set the initial value of text field
                      ...
                      Align(
                        ...
                        child: RaisedButton(
                          onPressed: () async {
                            ...
                            updateSprint(
                              "624d5ffbf69bc8440ce0c0e3", //GET THE ID
                              sprintController.sprintnameEditingController.text,
                              sprintController.startdateEditingController.text,
                              sprintController.duedateEditingController.text,
                            );
                          },
  ...
  void updateSprint(String id, String name, String startDate, String dueDate) {
    sprintController.updateSprint(
        {"_id": id, "name": name, "startDate": startDate, "dueDate": dueDate},
        id);
    //Get.back();
  }
}
